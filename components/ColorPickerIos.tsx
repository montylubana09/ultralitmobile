...
// import ColorPick from 'react-native-color-picker-ios';
// import ColorPicker, {
//   Swatches,
//   Preview,
//   OpacitySlider,
...
//               {/* Render the modal only for Android */}
...
export default function ColorPickerIos() {
  ...
  const handlePress = (index: number) => {
    ColorPick.showColorPicker(
      {supportsAlpha: true, initialColor: selectedColors[index]},
      color => {
        // updateSelectedColor(index, color.hex);
        console.log(color);
      },
    );
  };

  const updateSelectedColor = (index: number, colorHex: string) => {
    const updatedColors = [...selectedColors];
